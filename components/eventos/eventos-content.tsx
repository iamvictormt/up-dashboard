  ...
  return (
    <div className="p-6 md:p-8 w-full">
      <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-6 md:p-8 border border-[#511A2B]/10 shadow-lg w-full">
        ...
        {/* Loading State */}
        {isLoading ? (
          <ListingLoading message="Carregando eventos..." />
        ) : (
          <>
            {/* Events Grid */}
            {filteredEvents.length > 0 ? (
              ...
              <ListingEmpty
                ...
                icon={<Calendar className="h-12 w-12 text-[#511A2B]/30" />}
                title={searchQuery ? 'Nenhum evento encontrado' : 'Nenhum evento disponível'}
                description={
                  searchQuery
