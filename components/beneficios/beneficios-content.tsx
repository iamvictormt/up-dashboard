...
import { Search, Gift, Package, History } from 'lucide-react';
import { fetchAvailableBenefits, fetchMyRedemptions, redeemBenefit } from '@/lib/beneficios-api';
  ...
  return (
    <div className="p-6 md:p-8 w-full">
      <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-6 md:p-8 border border-[#511A2B]/10 shadow-lg w-full">
        ...
        {isLoading ? (
          <ListingLoading
            message={viewMode === 'available' ? 'Carregando benefícios...' : 'Carregando resgates...'}
          />
        ) : (
          <>
            {viewMode === 'available' ? (
              filteredBenefits.length > 0 ? (
                ...
                <ListingEmpty
                  ...
                  icon={<Gift className="h-12 w-12 text-[#511A2B]/30" />}
              ...
              <ListingEmpty
                isSearch={!!searchQuery}
                icon={<History className="h-12 w-12 text-[#511A2B]/30" />}
