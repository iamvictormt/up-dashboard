...
import { ProfessionalCard } from '@/components/prestadores-de-servicos/service-provider-card';
  ...
  return (
    <div className="p-6 md:p-8 w-full">
      <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-6 md:p-8 border border-[#511A2B]/10 shadow-lg w-full">
        ...
        {/* Loading / Grid */}
        {isLoading ? (
          <ListingLoading message="Carregando profissionais..." />
        ) : (
          <>
            {professionals.length > 0 ? (
              ...
              <ListingEmpty
                ...
                icon={<Users className="h-12 w-12 text-[#511A2B]/30" />}
