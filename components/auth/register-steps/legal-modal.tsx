...
export function LegalModal({ onTermsClick, onPrivacyClick }: LegalModalsProps) {
  ...
  return (
    <>
      ...
      <p className="text-xs text-muted-foreground">
        ...
        <span onClick={handleTermsClick} className="text-primary hover:underline cursor-pointer">
          Termos de Uso
        </span>{' '}
        e{' '}
        <span onClick={handlePrivacyClick} className="text-primary hover:underline cursor-pointer">
        ...
        <DialogContent className="max-w-4xl p-0 gap-0">
          <DialogHeader className="p-6 pb-4 border-b border-slate-200">
            <div className="flex items-center gap-3">
              ...
              <div>
                <DialogTitle className="text-xl font-semibold text-slate-900">Termos de Uso</DialogTitle>
        ...
        <DialogContent className="max-w-4xl p-0 gap-0">
          <DialogHeader className="p-6 pb-4 border-b border-slate-200">
            <div className="flex items-center gap-3">
              ...
              <div>
                <DialogTitle className="text-xl font-semibold text-slate-900">Política de Privacidade</DialogTitle>
                <p className="text-sm text-slate-600 mt-1">Última atualização: Junho de 2025</p>
              </div>
            </div>
          </DialogHeader>
